...
const New_Year_Hiyori_Rei_Dear_Smile = Characters.New_Year_Hiyori_Rei.Dear_Smile;
const New_Year_Hiyori_Rei_Friend_HighTouch = Characters.New_Year_Hiyori_Rei.Friend_HighTouch;
...
// // // // // // // Halloween // // // // // // //
const Halloween_Ninon_Suzuna_Dear_Idle = Characters.Halloween_Ninon_Suzuna.Dear_Idle;
const Halloween_Ninon_Suzuna_Dear_Smile = Characters.Halloween_Ninon_Suzuna.Dear_Smile;
const Halloween_Ninon_Suzuna_Friend_HighTouch = Characters.Halloween_Ninon_Suzuna.Friend_HighTouch;

// // // // // // // Christmas // // // // // // //
const Christmas_Akari_Yori_Dear_Idle = Characters.Christmas_Akari_Yori.Dear_Idle;
const Christmas_Akari_Yori_Dear_Smile = Characters.Christmas_Akari_Yori.Dear_Smile;
const Christmas_Akari_Yori_Friend_HighTouch = Characters.Christmas_Akari_Yori.Friend_HighTouch;
...
function Credits() {
  ...
  useEffect(() => {
    ...
    const initialCharacterIndex = Math.floor(Math.random() * (isSummer ? dearIdleSummer.length : dearIdleDefault.length));
    ...
    const updateGif = () => {
      setIsIdle((prevMode) => {
        setCurrentCharacterIndex((prevIndex) => {
          ...
          const friendHighTouchArray = isSummer ? friendHighTouchSummer : friendHighTouchDefault;
          if (prevMode === true) {
  ...
  }, [isSummer, dearIdleDefault, dearSmileDefault, friendHighTouchDefault, dearIdleSummer, dearSmileSummer, friendHighTouchSummer]);
  ...
  return (
    <section className="credits-CSS">
      <Container fluid>
        <img className="credits-gif-CSS" src={currentCharacter} alt="Credits Gif" />
      </Container>
    </section>
  );
}
